        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="col-sm-5 center">
                    ...
                    <a class="btn_premios" href="<?= Url::to(['site/awards']) ?>"><img class="" src="<?= Url::base() ?>/images/<?= $btn_premios->image_desktop ?>"/></a>
                    <a class="btn_empezar" href="<?= Url::to(['site/user']) ?>"><img class="" src="<?= Url::base() ?>/images/<?= $btn_empezar->image_desktop ?>"/></a>
                </div>
